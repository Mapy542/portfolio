...
![Stepper Motor Driver](arduino-mmv/testing-stepper-motor-driver.webp){Stepper motor driver that requires 6us pulses}
...
[Read More About the Laser Cutter](/k400-home)

#!g
![Nano M2 Output](arduino-mmv/mmv-in.webp){Inverted 1-2 us pulses from the Nano M2}
![MMV Output](arduino-mmv/mmv-out.webp){6us pulses from the MMV}
![Programming](arduino-mmv/programming.webp){Uploading code to the Arduino}
![Laser Cutter Electrical Cabinet](arduino-mmv/ecabinet.webp){The electrical cabinet of the laser cutter where the MMV was tested.}
#!g
